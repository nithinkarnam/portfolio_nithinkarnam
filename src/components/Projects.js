                ...
                <div class="container">
                    ...
                    <div class="card mb-3">
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                   <h3 class="card-title">Data Science Intern at <a href='https://www.goyaana.com/landing' target="_blank" rel="noopener noreferrer"> Goyaana</a></h3>
<ul>
    ...
    <li>Contributed to developing models and analytics that supported organizational strategies and improved overall customer engagement.</li>
                                    ...
                                    <a class="text-decoration-none text-primary" href="https://drive.google.com/file/d/1bneVb7ELV89N1sf4ArZJ5l89sVdKUjgI/view?usp=sharing" target="_blank" rel="noopener noreferrer">View Certificate</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card mb-10">
                                    ...
                                    <div class="card-body">
                                        ...
                                        &ensp; &ensp;
                                        <a class="text-decoration-none text-primary" href="https://artfolio-eight.vercel.app/" target="_blank" rel="noopener noreferrer">Website Link</a>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card mb-10">
                                    ...
                                    <div class="card-body">
                                        ...
                                        &ensp; &ensp;
                                        <a class="text-decoration-none text-primary" href="https://nithinkarnam-model-prediction-fertilizer-app-dkrlhs.streamlit.app/" target="_blank" rel="noopener noreferrer">Website Link</a>
                                    </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="card mb-10">
                                    ...
                                    <div class="card-body">
                                        ...
                                        &ensp; &ensp;
                                        <a class="text-decoration-none text-primary" href="#" target="_blank" rel="noopener noreferrer">Website Link</a>
                                    </div>
                            </div>
                        </div>
                        </div>
